 ...
 */
/* BEGIN CURAM-BIRT-CODE-CHANGE */
@SuppressWarnings({ "java:S1192", "java:S3008", "java:S2293", "java:S1171", "java:S112" }) // For not patched code.
/* END CURAM-BIRT-CODE-CHANGE */
public class ReportDesignWriter
{
	...
	public void write( OutputStream out, Report report ) throws Exception
	{
		...
		/*BEGIN CURAM-BIRT-CODE-CHANGE*/
		//DDocument document = DocumentBuilderFactory.newInstance( )
		//		.newDocumentBuilder( ).newDocument( );
		Document document = XmlProcessorFactory.createDocumentBuilderWithErrorOnDOCTYPE().newDocument( );
		/*END CURAM-BIRT-CODE-CHANGE*/
		...
		Transformer tr = XmlProcessorFactory.createTransformerFactoryWithErrorOnDOCTYPE().newTransformer( );
		/*END CURAM-BIRT-CODE-CHANGE*/

...
class SOAPFaultParser extends DefaultHandler
{
	 ...
	 */
	/* BEGIN CURAM-BIRT-CODE-CHANGE */
	@SuppressWarnings({ "java:S1874" }) // For not patched code.
	/* END CURAM-BIRT-CODE-CHANGE */	
	private Object createXMLReader( ) throws InstantiationException,
			IllegalAccessException, ClassNotFoundException/*BEGIN CURAM-BIRT-CODE-CHANGE*/,org.xml.sax.SAXNotRecognizedException,org.xml.sax.SAXNotSupportedException/*END CURAM-BIRT-CODE-CHANGE*/
	{
		try
		{
			Object xmlReader = Thread.currentThread( )
					...
					.newInstance( );
			/*BEGIN CURAM-BIRT-CODE-CHANGE*/
			((org.apache.xerces.parsers.SAXParser)xmlReader).setFeature("http://apache.org/xml/features/disallow-doctype-decl", true);
			/*END CURAM-BIRT-CODE-CHANGE*/
			return xmlReader;
		}
		catch ( ClassNotFoundException e )
		{
			...
			//		.newInstance( );
			Object xmlReader = Class.forName( "org.apache.xerces.parsers.SAXParser" ).newInstance( );
			((org.apache.xerces.parsers.SAXParser)xmlReader).setFeature("http://apache.org/xml/features/disallow-doctype-decl", true);
			return xmlReader;
			/*END CURAM-BIRT-CODE-CHANGE*/
		}
